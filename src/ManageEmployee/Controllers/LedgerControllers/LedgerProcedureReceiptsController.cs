...
[ApiController]
[Authorize]
public class LedgerProcedureReceiptsController : ControllerBase
{
    ...
    public LedgerProcedureReceiptsController(ILedgerProcedureProductService ledgerProduceExportService, ILedgerProcedureProductExporter ledgerProcedureProductExporter)
    {
    ...
    public async Task<IActionResult> GetAll([FromQuery] ProcedurePagingRequestModel param)
    {
        ...
        return Ok(await _ledgerProcedureProductService.GetPaging(param, userId, "PT"));
    }

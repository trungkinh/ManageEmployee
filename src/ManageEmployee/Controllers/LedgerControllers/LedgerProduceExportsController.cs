...
[ApiController]
[Authorize]
public class LedgerProduceExportsController : ControllerBase
{
    ...
    public LedgerProduceExportsController(ILedgerProcedureProductService ledgerProduceExportService, ILedgerProcedureProductExporter ledgerProcedureProductExporter)
    {
    ...
    public async Task<IActionResult> GetAll([FromQuery] ProcedurePagingRequestModel param)
    {
        ...
        return Ok(await _ledgerProcedureProductService.GetPaging(param, userId, "XK"));
    }
    [HttpGet("{id}")]

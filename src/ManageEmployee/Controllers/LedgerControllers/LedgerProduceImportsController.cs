...
[ApiController]
[Authorize]
public class LedgerProduceImportsController : ControllerBase
{
    ...
    public LedgerProduceImportsController(ILedgerProcedureProductService ledgerProduceImportService, ILedgerProcedureProductExporter ledgerProcedureProductExporter)
    {
        _ledgerProcedureProductService = ledgerProduceImportService;
    ...
    public async Task<IActionResult> GetAll([FromQuery] ProcedurePagingRequestModel param)
    {
        ...
        return Ok(await _ledgerProcedureProductService.GetPaging(param, userId, "NK"));
    }
    ...
    {
        var generatedFileName = await _ledgerProcedureProductExporter.Export(id);
